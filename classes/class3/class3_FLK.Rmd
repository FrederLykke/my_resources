...
knitr::opts_knit$set(root.dir = "C:\\methods02\\my_resources\\classes")
...
#Define the sum-tracker:
my_sum <- 0

#Loop through the first 100 positive integers and add them to the sum-tracker:
for (i in 1:100){
  my_sum <- my_sum + i
}
...
#Create an empty vector to store the squared values:
my_sum <- 0

#Loop through the first 20 positive integers and add the squared value to the sum-tracker:
for (i in 1:20){
  my_sum <- my_sum + i^2
}
...
#Print the result:
print(paste("The smallest integer n such that the sum of the first n positive integers is greater than 1000 is:", n - 1))
...
# Function to categorize a person's age
categorize_age <- function(age) {
  if (age < 12) {
    print(paste(age, "is a child."))
  } else if (age >= 12 & age <= 18) {
    print(paste(age, "is a teenager."))
  } else if (age >= 19 & age <= 65) {
    print(paste(age, "is an adult."))
  } else {
    print(paste(age, "is a senior."))
  }
}
...
calculate_mean <- function(numbers) {
  if (length(numbers) == 0) {
    ...
    return(mean(numbers))  # Calculate and return the mean of the vector
  }
}
